...
public class ResourceLoader  {
	...
	private List<Holder> callbacks = new ArrayList<Holder>();
	...
	private List<ResourceCallback> findCallbacksFor( String href ) {
		List<ResourceCallback> result = new ArrayList<ResourceCallback>();
	...
	public void registerCallback( String forHref, ResourceCallback callback ) {
        ...
        try {
            holder.href = URLDecoder.decode(forHref, Charset.defaultCharset().name());
